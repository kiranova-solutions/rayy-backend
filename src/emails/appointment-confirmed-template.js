const appointmentConfirmedTemplate = (name, appointmentData) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="message">Your appointment has been confirmed by the vendor. We look forward to serving you!</div>
...
module.exports = appointmentConfirmedTemplate;