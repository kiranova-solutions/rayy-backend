const bookingCreationTemplate = (name, bookingData) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="message">We have received your appointment booking request at ${bookingData.storeName}.Below are your booking details:</div>
        ...
        <div class="message">Please stay tuned for further updates on your appointment</div>
        <div class="footer">
            <img src="https://rayy.s3.ap-south-1.amazonaws.com/Others/Logo.png" alt="Ray Salon Logo">
...
module.exports = bookingCreationTemplate;
