const appointmentCancelledTemplate = (name, bookingData) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="message">We regret to inform you that your appointment has been cancelled by the vendor.</div>
        <div class="details-container">
            ...
            <div class="detail-item"><strong>Cancellation Reason:</strong> ${bookingData.cancellationReason}</div>
            <div class="detail-item"><strong>Cancellation Description:</strong> ${bookingData.cancellationDescription}</div>
        </div>
        <div class="message">If you have any questions, feel free to contact us.</div>
        <div class="footer">
            <img src="https://rayy.s3.ap-south-1.amazonaws.com/Others/Logo.png" alt="Ray Salon Logo">
