...
const bookingCreateSMS = ({ recipientNumber, var1, var2, var3 ,var4}) => {
...
const bookingCreateVendorSMS = ({ recipientNumber, var1, var2, var3 ,var4}) => {
  return new Promise((resolve, reject) => {
    const options = {
      url: "https://api.enablex.io/sms/v1/messages/",
      json: true,
